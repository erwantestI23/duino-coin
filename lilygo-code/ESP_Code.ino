...
#include "MiningJob.h"
#include "Settings.h"
#include "DisplayHal.h" // Toujours inclus
...
void display_tft_mining_results(float hashrate, unsigned long accepted_shares, unsigned long total_shares) {
    #if defined(DISPLAY_TFT_ST7735)
        tft.fillScreen(TFT_BLACK);
        tft.setCursor(0, 0);
